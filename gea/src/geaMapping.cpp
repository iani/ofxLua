...
//--------------------------------------------------------------
void ofxGeaMapping::setupMapping(){
...
//--------------------------------------------------------------
void ofxGeaMapping::updateMapping(){
...
//--------------------------------------------------------------
void ofxGeaMapping::drawMapping(){
    if(drawGrid){
        ofPushMatrix();
...
//--------------------------------------------------------------
void ofxGeaMapping::resetMappingPoints(){
    // warped grid reset
...
//--------------------------------------------------------------
void ofxGeaMapping::loadMappingPoints(){
...
//--------------------------------------------------------------
void ofxGeaMapping::saveMappingPoints(){
...
//--------------------------------------------------------------
void ofxGeaMapping::toggleDrawGrid(){
    drawGrid = !drawGrid;
}

//--------------------------------------------------------------
bool ofxGeaMapping::switchMouseKeyControl(){
...
//--------------------------------------------------------------
void ofxGeaMapping::manualPointEditON(){
    if(!activateMouseMapping){
...
//--------------------------------------------------------------
void ofxGeaMapping::manualPointEditOFF(){
    if(!activateMouseMapping){
...
//--------------------------------------------------------------
void ofxGeaMapping::northMappingPoint(){
    if(!activateMouseMapping){
...
//--------------------------------------------------------------
void ofxGeaMapping::southMappingPoint(){
    if(!activateMouseMapping){
        if(manualEditMappingPoint){
            finalTextureMapping.points[actualMappingPoint].y++;
        }else{
...
//--------------------------------------------------------------
void ofxGeaMapping::eastMappingPoint(){
    if(!activateMouseMapping){
        if(!manualEditMappingPoint){
...
//--------------------------------------------------------------
void ofxGeaMapping::westMappingPoint(){
    if(!activateMouseMapping){
        if(!manualEditMappingPoint){
...
//--------------------------------------------------------------
void ofxGeaMapping::applyHomography(){
/*
...
//--------------------------------------------------------------
void ofxGeaMapping::applyGridMesh(int xCalib, int yCalib, int w, int h){
